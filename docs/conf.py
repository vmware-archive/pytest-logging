# -*- coding: utf-8 -*-
#
# pytest-logging documentation build configuration file, created by
...
project = u'pytest-logging'
copyright = u'2015, Pedro Algarvio'
author = u'Pedro Algarvio'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-logging Documentation',
     [author], 1)
]
